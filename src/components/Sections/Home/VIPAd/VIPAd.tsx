...
import { VIPinner, VIPgrid, CardWrapper, CardImage, CardTitle, CardFooter, CardFooterInfo, CardFooterContant, CardPrice, CardFavoritesIcon } from './VIPAd.elements'
    ...
    return (
        <Card>
            <CardWrapper>
                ...
                <CardTitle>
                    Авто на продажу по низкой цене
                </CardTitle>
                <CardFooter>
                    <CardFooterInfo>Киев, Дарницкий - 14 груд.</CardFooterInfo>
                    <CardFooterContant>
                        <CardPrice>10 500000</CardPrice>
                        <CardFavoritesIcon>
                            <FaHeart size={20}/>
                        </CardFavoritesIcon>
                    </CardFooterContant>
